        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{{route('admin-crear_permiso',['pagVolver' => 'admin-permiso-index'])}}" class="btn btn-block btn-success btn-sm" style="max-width: 200px">
                    ...
                    <tbody>
                        @foreach($permisos as $permiso)
                            <tr>
                                ...
                                <td>{{$permiso->slug}}</td>
                                <td>
                                    <a href="{{route('admin-editar_permiso', ['id' => $permiso->id])}}" class="btn-accion-tabla tooltipsC" title="Editar este registro">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form action="{{route('admin-eliminar_permiso',  ['id' => $permiso->id])}}" class="d-inline form-eliminar" method="POST">
                                        @csrf @method("delete")
