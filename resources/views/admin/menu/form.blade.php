<div class="form-group row">
    ...
    <div class="col-lg-8">
        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del Men&uacute;" value="{{ old('nombre', $data->nombre ?? ' ') }}" required>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-lg-8">
        <input type="text" class="form-control" id="url" name="url" placeholder="Url del Men&uacute;" value="{{ old('url', $data->url ?? ' ') }}" required>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-lg-7">
        <select id="icono" class="form-control" name="icono">
            ...
            @foreach ($iconos as $icono)
                @if($data!=NULL)
                    <option value="{{ $icono->clase_icono }}" @if($icono->clase_icono == $data->icono) selected @endif >{{ $icono->nom_icono }}</option>
                @else
