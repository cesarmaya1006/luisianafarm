...
class RolController extends Controller
{
    ...
    public function crear($pagVolver)    {
        ...
        return view('admin.rol.crear',compact('pagVolver'));
    }
    ...
    {
        $pagVolver='admin-rol-index';
        Rol::create($request->all());
        return redirect('admin/rol-crear/'.$pagVolver)->with('mensaje', 'Rol creado con exito')->with('pagVolver');
    }
